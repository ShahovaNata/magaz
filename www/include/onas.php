	...
	<div id="block-body">
		...
		include("include/block-header.php");
		 ...
		 <div id="block-content">
		 	...
		 	<p>Наш магазин «Brio» предлагает Вам огромный ассортимент продукции, среди которого вы найдете как предметы интерьера для жилых и нежилых помещений – вазы, картины, кашпо, подсвечники, фонари, клетки, лампы, фоторамки, часы, так и тематические и сезонные товары – предметы для декорирования пасхального стола, новогодняя и рождественская тематика, тема 8 Марта, Дня Святого Валентина, а также предметы личного пользования – заколки, ободки, банданы. И это далеко не весь перечень товаров, которые можно приобрести в нашем интернет-магазине.</p>
		 </div>
